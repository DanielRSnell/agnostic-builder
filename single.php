        ...
        if (!get_theme_mod("singlepost_disable_entry_cats") && has_category()) {
            ?>
		                        <div class="entry-categories">
		                            <span class="screen-reader-text"><?php _e('Categories', 'agnostic-blocks');?></span>
		                ...
		                <?php if (!get_theme_mod("singlepost_disable_date") or !get_theme_mod("singlepost_disable_author")): ?>
		                    <div class="post-meta" id="single-post-meta">
	                            ...
	                            <?php if (!get_theme_mod("singlepost_disable_author")): ?>
	                                <span class="post-author"> <?php _e('by', 'agnostic-blocks')?> <?php the_author();?></span>
	                            <?php endif;?>
                        </p>
                    </div>
                <?php endif;?>
...
if (get_theme_mod("enable_sharing_buttons")) {
    picostrap_the_sharing_buttons();
}

edit_post_link(__('Edit this post', 'agnostic-blocks'), '<p class="text-end">', '</p>');
...
endwhile;
    ...
    _e('Sorry, no posts matched your criteria.', 'agnostic-blocks');
endif;
?>
